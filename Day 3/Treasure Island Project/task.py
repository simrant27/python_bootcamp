...
if choice1 == "left":
    choice2 = input('You\'ve come to lake. There is island in the middle of lake \n '
                    'type "wait" to wait a boat and "swim" to swim across\n').lower()
    if choice2 == "wait":
        ...
        if choice3 == "yellow":
            print("You found treasure, congrats")
        if choice3 == "blue":
